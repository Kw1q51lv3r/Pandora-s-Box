...
products.addProduct("Leah's Rescue Serum", "Moisturiser, Hair, 500ml", "05", 49, "Your hair dries out a lot in the sun, but it doesn't have to. Keep it strong and healthy with a moisturiser, because that's what a moisturiser does.", "The construction industry makes up 40% of global energy consumption.", "images/moisturiser.jpg", 4, "E", "Moisturisers");

products.addProduct("Grapefruit Body Wash", "Bodywash, Grapefruit, 500ml", "06", 29, "Feel fresh and energised with the light pep from the citrus kick of this grapefruit bodywash. If you want to be performing at your best, you'll want all the help you can get.", "The US Military consumes more fossil fuels than the entire country of Finland.", "images/shampoo1.jpg", 2, "E", "Bodywashes");

products.addProduct("Ciara Face Wash", "Facewash, Exfoliating, 200ml", "07", 27, "The face is one of the most sensitive parts of your body, and it helps to keep it radiant and healthy- no, not in that way, use this facewash instead!", "Disposable coffee cups cannot be properly recycled, and even compostable ones last for decades in landfills.", "images/facewash.jpg", 3, "E", "Face Washes");

//(product, productName, productID, productPrice, productDescription, productTrivia, productImg, productRemarks, productCategory)

products.addProduct("Olive Hand Cream", "Moisturiser, Hand, Shea Butter, 200ml", "08", 18, "When you interface with the world every day, what do you use? Your hands. You live your life through them; you owe it to yourself to take care of them.", "In 1992, McDonald's served Stella Liebeck coffee that gave her third-degree burns and disabled her for two years afterwards. She sued McDonald's to cover her $200,000 medical expense, where the jury voted to also award her the now-famous $2.7 million in punitive damages. She did not get the money.", "images/handcream.jpg", 6, "E", "Hand Cream");

products.addProduct("Rosehip Facial Oil", "Face Oil, Rosehip, 200ml", "09", 49, "You go through life face-first. When people identify you, it is by your face. Significant aspects of communcation are done with your face. Doll your face up and give life the Glasgow Kiss it deserves.", "'Do not operate heavy machinery' most often specifically means driving your car.", "images/menbodywash.jpg", 6, "E", "Facial Oil");

products.addProduct("Charcoal Toothpaste", "Toothpaste, Charcoal, 150g", "10", 4, "Charcoal has been used as a medicinal agent for centuries, preventing the absorption of harmful substances by the body. It's edible, too. Makes sense to clean your mouth with it.", "Environmentalists were successful in getting Germany to de-nuclearise its power grid, resulting in greatly increased lignite coal production... which they burn in Poland.", "images/essentialoil.jpg", 2, "E", "Oral Care");

products.addProduct("Toothbrush", "Toothbrush, Medium Bristles", "B", 11, "... it's just a toothbrush.", "Three-quarters of all transportation-associated pollution comes from road vehicles.", "images/menbodywash.jpg", 4, "E", "Oral Care");

products.addProduct("Mini-scent Dental Floss", "Dental Floss, Mint, Waxed, 75m", "12", 3, "There's a few places that your toothbrush can't reach. Use this to reach them.", "Marine transportation has a future in sustainable technologies, but air transport does not.", "images/menbodywash.jpg", 3, "E", "Oral Care");

products.addProduct("Supima Cotton Crop Top", "Ladies' Top, Supima Cotton, Cropped Cut", "13", 48, "Women's crop cut. For satisfying your fashion and/or aesthetic needs. Made to last. If worn out or otherwise no longer desired, please bundle and return with our box.", "Fast fashion contributes almost 100 million tons to landfill disposal every year.", "images/pinkcrop.jpg", 6, "E", "Apparel");

products.addProduct("Oversized T-shirt", "Unisex Tee, Cotton/Polyester Blend, Wide Cut", "14", 35, "Unisex loose cut. For satisfying your fashion and/or aesthetic needs. Light, airy, and comfortable. Made to last. If worn out or otherwise no longer desired, please bundle and return with our box.", "Clothing sales doubled between 2000 and 2015, with the average clothing item being worn 20% less.", "images/blackshirt.jpg", 6, "E", "Apparel");

products.addProduct("Unisex Polo Tee", "Polo Shirt, Cotton/Polyester Blend, Standard Cut", "15", 39, "Unisex. For satisfying your fashion and/or aesthetic needs. Light, breathable, and comfortable. Made to last. If worn out or otherwise no longer desired, please bundle and return with our box.", "The anti-nuclear movement, as a subsection of the environmentalist movement, is heavily funded by fossil fuel interests.", "images/mwwhiteshirt.jpg", 6, "E", "Apparel");
